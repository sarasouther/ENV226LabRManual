...
> **Skills this lab builds.** *4DEE:* Cross-Cutting Themes → Evolution. Core Ecological Concepts → Populations. Ecology Practices → Designing, conducting, and critiquing investigations. *BioSkills:* Process of Science → "Develop research questions based on your own or others' observations."
...
- [Download the CSV file](downloads/naturalselectiondatasheet.csv)
- [Download the R file](downloads/NaturalSelection.R)
...
Your final product will be a lab report containing only research question, hypothesis, methods, and results (Format 1) as described in the “Written Lab Report Guidelines” here:
[Lab report guidelines](#labreport)
