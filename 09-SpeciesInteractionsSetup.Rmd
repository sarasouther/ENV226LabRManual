# Species interactions I: designing and planting your experiment

> **Skills this lab builds.** *4DEE:* Core Ecological Concepts → Communities. Ecology Practices → Designing, conducting, and critiquing investigations; Working collaboratively. *BioSkills:* Process of Science → "Formulate testable hypotheses and state their predictions"; "Design controlled experiments, including plans for analyzing the data."

> **This lab is not a one-week lab, and it does not run in the order the manual is printed in.** You plant your experiment today. Then, for the next six to eight weeks, you visit the greenhouse **once a week** to measure your plants — while the class is working through other labs. At the end of the semester you harvest, analyze, and present a poster. That last part is its own chapter: **Species interactions II: analysis and poster**, near the end of this manual. Read this chapter now; read that one when your plants come out of the greenhouse.
...
- [A reading about plant species interactions](downloads/HuotEtAl2014.pdf)
- [Experimental design worksheet for turn-in](downloads/EcologicalInteractions_TurninWeek1.docx)
- [An example data sheet](downloads/SpeciesInteractionsDatasheet.csv)
...
- [View NAU greenhouse location on Google Maps](https://maps.app.goo.gl/UHgzcexkYzsEHVPW7)
...
![](images/10-speciesinteractions/examplelabel.png)
...
1. You should create a data sheet with your group members to successfully record your data
for the next 6 - 8 weeks. Do this by modifying the example data sheet that we have provided.
...
> **Set the sheet up properly now, not later.** You are about to spend eight weeks adding rows to this file. Every rule from **Working with data in a spreadsheet** applies: one rectangle, one variable per column, one observation per row, plain column names, and one consistent marker for missing data. A sheet that is awkward in week 1 is unusable by week 8, and you will not want to retype it the night before the poster is due.
...
**A missed week is a hole in your dataset that cannot be filled in afterwards.** Growth measurements are a time series — you cannot reconstruct week 4 in week 5. Put the greenhouse visit in your calendar the way you would a shift, and if the person whose turn it is can't go, swap rather than skip.

## What happens next

When your plants come out of the greenhouse, go to **Species interactions II: analysis and poster** for the harvest protocol, the analysis, and the poster requirements. You may want to skim that chapter now, so you know what you'll be asked to produce — it is much easier to collect the right data for eight weeks if you already know what the poster needs.
