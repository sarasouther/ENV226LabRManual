...
![Adjusting the layout of your workspace](images/01-intro/PaneLayout.png){width=25%, height=auto}
...
![Finding your path](images/01-intro/workingdirectorymac.png){width=5%, height=auto}
Then, select 'Get info'. Then, highlight the information after 'where' and copy it as a pathname (see picture).

![Copying pathnames](images/01-intro/copyingpathnamemac.png){width=5%, height=auto}
