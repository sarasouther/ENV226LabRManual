...
```{r population ecology, include=FALSE}
...
5.	Count the number of thalli in each cup on Day 7 and Day 14. These counts are already reflected in the datasheet for this lab, but you will need to record population size going forward [Download the CSV file](downloads/duckweeddatasheet.csv) 
...
5.	Count the number of thalli in each cup on Day 7 and Day 14. Record these data in the population size column of your datasheet.
...
Let’s start by plotting population growth through time. [Download the R file](downloads/) 
...
4) Summarize the findings and draw conclusions about the factors influencing population dynamics and discuss the implications of the study for understanding population ecology in natural ecosystems.
