...
> **Skills this lab builds.** *4DEE:* Core Ecological Concepts → Communities. Ecology Practices → Designing, conducting, and critiquing investigations; Working collaboratively; Communicating and applying ecology. *BioSkills:* Process of Science → "Formulate testable hypotheses and state their predictions"; Communication & Collaboration → "Use a variety of modes to communicate science (e.g., oral, written, visual)."
...
Refer back to lab manual chapters 3 and 4 for a reminder about descriptive and inferential statistics. To run statistical tests on your data, refer to lab manual chapter 5: Selecting statistical tests, found here [Selecting Statistical Tests](selecting-statistical-tests.html). You can modify the R code to run your own statistical tests.  
