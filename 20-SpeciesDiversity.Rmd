...
> **Skills this lab builds.** *4DEE:* Core Ecological Concepts → Communities. Ecology Practices → Natural history; Quantitative reasoning and computational thinking. *BioSkills:* Quantitative Reasoning → "Interpret the biological meaning of quantitative results"; Science & Society → Ethics.
...
[Directions to the meeting area](downloads/DirectionsToCompostSite.docx) and a [map of the compost site](downloads/MapToCompost.pdf)

[Exact location of the compost pile](https://maps.app.goo.gl/BTxo4DuPnW1kboyc8)
...
1. Collect soil from the NAU campus compost facility. Working together, be sure to collect soil from different depths (surface, deep - collect from where the compost is actually warm!) within the pile and be sure to track at which depth the soil was collected. If weather is poor, your TA may have collected soil for you.
...
4. Pour approximately 1 inch of half water, half 90% isopropyl alcohol or an ethnanol solution (depends on what form of alcohol is provided) into a 20-mL vial (3/4 full). Label the funnel with the same information as the PVC pipe. Place the vial beneath the funnel.
...
- **Note**: Depending on the year, and who has been using the funnels, you may not have to complete particular steps (i.e., changing light bulbs). Follow your TAs instructions.

When you return to lab, you will examine the contents of the 20-mL vials to observe the organisms that have been collected, and identify them using keys. You will then perform data analysis, calculating diversity metrics.  
...
- [Data sheets for recording arthropod diversity](downloads/IndividualTallySheets.docx)
- [Taxon recording table](downloads/TaxonRecordingDoc.docx)
- [Taxonomic key for arthropod identification](downloads/SoilInvertebrateKey.pdf)
- [Excel files to calculate diversity](downloads/DiversityCalculator.xlsx)
- [Reading on Shannon's Index](downloads/ShannonDiversityReading.pdf)
- [Discussion questions](downloads/DiscussionQuestions.docx)
...
You will be identifying invertebrates (Arthropods) from the compost using dissecting  microscopes and dichotomous keys. Use the dichotomous key provided to make your best  guess at the taxon for each organism in your sample. Record abundances in each sample in the datasheet that you downloaded.
...
Material in this lab is based mainly on: Boyce, Richard L. 2005. Life under your feet: measuring soil invertebrate diversity. <https://tiee.esa.org/vol/v3/experiments/soil/abstract.html> 
